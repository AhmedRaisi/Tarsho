...
<div className="content-overlay">
      <div id="about" className="mission-section">
        <h2>Our Mission</h2>
        <p>
          "To empower service providers with the tools and visibility they need
          to grow their businesses while providing clients with an unparalleled
          selection of specialized services..."
        </p>
      </div>
      ...
      <div className="about-section">
        <h2>Our Story</h2>
        <p>
          Born from a vision to bridge the gap between independent service
          providers and clients seeking bespoke services, Tarsho emerged as the
      ...
      <div className="vision-section">
        <h2>Our Vision</h2>
        <p>
          "To be the leading platform where independent service providers
          flourish and clients discover a world of tailor-made services..."
        </p>
      </div>
      <div id="services" className="services-container">
        ...
        <div className="services-section">
          <div className="service client">
            <h2>For Clients</h2>
            <p>
              Discover top independent service providers tailored to your
              business needs.
            </p>
            <button
          ...
          <div className="service provider">
            <h2>For Providers</h2>
            <p>
              Join our network to showcase your services to a broader clientele.
            </p>
            <button
              onClick={() => openLoginModal('provider')}
              className="login-button"
            >
              Provider Login
            </button>
