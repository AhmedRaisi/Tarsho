    ...
    <>
      ...
      <div id='home' className='hero-section'>
        <div className='hero-content'>
          ...
          <p className='hero-main-text'>Empowering Your Independence, Enriching Your Choices</p>
          <p className='hero-subtext'>Tarsho is where businesses and clients connect to turn unique visions into vibrant realities.</p>
      ...
      <div className='content-overlay'>
        <div id='about' className='mission-section'>
          <h2>Our Mission</h2>
          <p>
            &quotTo empower service providers with the tools and visibility they need to grow their businesses while providing clients with
            an unparalleled selection of specialized services...&quot
          </p>
        </div>
        ...
        <div className='about-section'>
          <h2>Our Story</h2>
          <p>
            Born from a vision to bridge the gap between independent service providers and clients seeking bespoke services, Tarsho emerged
            as the catalyst for entrepreneurial success...
          </p>
        </div>
