...
import ProviderProviderProfile from './components/pages/provider/profile/ProviderProviderProfile'
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path='/provider/provider/:userId' element={<ProviderProviderProfile />} />
      </Routes>
    </Router>
  )
}
